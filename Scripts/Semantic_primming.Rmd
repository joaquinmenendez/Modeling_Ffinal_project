...
```{r}
raw1 = read.csv(file = files[1], header = F)
raw1
...
raw2 = read.csv(file = files[1], skip = 30)[c(-267:-600),] 
...
actual_file = as.data.frame(files[1],header = F)
...
similitud = read.csv(file = files[1], skip = 453, header = F)[c(-65:-75),]
